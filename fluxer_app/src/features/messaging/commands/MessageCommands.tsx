...
import {DELETE_MESSAGE_DESCRIPTOR, END_POLL_NOW_DESCRIPTOR, OKAY_DESCRIPTOR} from '@app/features/i18n/utils/CommonMessageDescriptors';
...
export function showEndPollConfirmation(
	i18n: I18n,
	{
		message,
		onEndPoll,
	}: ShowEndPollConfirmationOptions,
): void {
	ModalCommands.push(
		modal(() => (
			<ConfirmModal
...
export function endPoll(i18n: I18n, channelId: string, messageId: string): void {
	...
	http.post(Endpoints.CHANNEL_POLL_EXPIRE(channelId, messageId)).catch((error) => {
